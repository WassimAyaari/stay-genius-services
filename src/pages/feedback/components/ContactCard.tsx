    ...
    <div className="mb-8">
      <Card className="p-6 rounded-xl bg-primary text-white">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="secondary" className="w-full bg-white text-primary hover:bg-gray-100 font-medium">
            {t('feedback.contact.callReception')}
          </Button>
          <Button variant="outline" className="w-full border-white text-white hover:bg-white/20 font-medium">
