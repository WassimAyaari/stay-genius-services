  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button variant={assignedToName ? "default" : "outline"} size="sm" className="gap-1 whitespace-nowrap" style={assignedToName ? { backgroundColor: '#ddeac3
', color: '#1f2937' } : undefined}>
