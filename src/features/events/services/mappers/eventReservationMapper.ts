...
/**
 * Maps a database row to our EventReservation type
 */
...
/**
 * Maps a CreateEventReservationDTO to a database row format
 */
export const mapDtoToRow = (dto: any, userId?: string | null) => ({
